...
var _user$project$DjPostgres$databaseDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$DjPostgres$Database,
	A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
	...
	A2(
		...
		_elm_lang$core$Json_Decode$bool));
var _user$project$DjPostgres$databasesDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'databases',
...
var _user$project$DjPostgres$tableDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$DjPostgres$Table,
	A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
		...
		_elm_lang$core$Json_Decode$string));
var _user$project$DjPostgres$tablesDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'tables',
...
var _user$project$DjPostgres$QueryResult = F8(
	function (a, b, c, d, e, f, g, h) {
		return {columns: a, results: b, page: c, totalPage: d, count: e, totalCount: f, from: g, to: h};
	});
var _user$project$DjPostgres$tableContentDecoder = A9(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$list(
			_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string))),
	A2(_elm_lang$core$Json_Decode$field, 'page', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'total_page', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'count', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'total_count', _elm_lang$core$Json_Decode$int),
...
var _user$project$DjPostgres$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {currentPage: a, currentDatabase: b, currentTable: c, currentQueryPage: d, databases: e, tables: f, queryResult: g, resultsPerPage: h};
	});
...
var _user$project$DjPostgres$getInitialModel = A8(
...
var _user$project$DjPostgres$getTableContent = function (model) {
	var _p1 = model.currentDatabase;
	if (_p1.ctor === 'Nothing') {
		return _elm_lang$core$Platform_Cmd$none;
	} else {
		var _p2 = model.currentTable;
		if (_p2.ctor === 'Nothing') {
			return _elm_lang$core$Platform_Cmd$none;
		} else {
			var url = A2(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(model.currentQueryPage),
									A2(
										_elm_lang$core$Basics_ops['++'],
										'/',
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(model.resultsPerPage),
											'/'))))))));
			return A2(
				_elm_lang$http$Http$send,
				_user$project$DjPostgres$GotTableContent,
				A2(_elm_lang$http$Http$get, url, _user$project$DjPostgres$tableContentDecoder));
		}
	}
};
	...
	return A2(
		_elm_lang$html$Html$a,
		{
			...
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$DjPostgres$ClickTablePage(
					{ctor: '_Tuple2', _0: table.name, _1: 1})),
			_1: {
				ctor: '::',
...
var _user$project$DjPostgres$renderPagination = function (model) {
	...
	if (_p4.ctor === 'Nothing') {
		...
		return _elm_lang$core$Native_Utils.eq(model.queryResult.totalPage, 1) ? A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{ctor: '[]'}) : A2(
			_elm_lang$html$Html$ul,
			...
			A2(
				_elm_lang$core$List$map,
				function (pageIndex) {
					return _elm_lang$core$Native_Utils.eq(pageIndex, model.currentQueryPage) ? A2(
						_elm_lang$html$Html$li,
						{
							ctor: '::',
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(pageIndex)),
							_1: {ctor: '[]'}
						}) : A2(
						_elm_lang$html$Html$li,
						{ctor: '[]'},
						{
							...
							_0: A2(
								_elm_lang$html$Html$a,
								{
									...
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$DjPostgres$ClickTablePage(
											{ctor: '_Tuple2', _0: _p4._0, _1: pageIndex})),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href('#view-table'),
										_1: {ctor: '[]'}
	...
	return A2(
		...
		},
		{
					...
					_0: A2(
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(result.count),
									A2(
										_elm_lang$core$Basics_ops['++'],
										' results out of ',
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(result.totalCount),
											A2(
												_elm_lang$core$Basics_ops['++'],
												' records (',
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(result.from),
													A2(
														_elm_lang$core$Basics_ops['++'],
														' to ',
														A2(
															_elm_lang$core$Basics_ops['++'],
															_elm_lang$core$Basics$toString(result.to),
															').')))))))),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$DjPostgres$renderPagination(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$DjPostgres$getTables = function (model) {
	...
	if (_p5.ctor === 'Nothing') {
		...
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			'http://localhost:8000/djpg/api/database/',
			A2(_elm_lang$core$Basics_ops['++'], _p5._0, '/tables/'));
		return A2(
			_elm_lang$http$Http$send,
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$DjPostgres$ClickDatabasePage(_p7)),
							_1: {ctor: '[]'}
						}
					},
					{
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$DjPostgres$ClickDatabasePage(database.djangoName)),
					_1: {
						ctor: '::',
...
var _user$project$DjPostgres$renderSelectDatabasePage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Select Database:'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					_elm_lang$core$Array$toList(
						A2(_elm_lang$core$Array$map, _user$project$DjPostgres$renderDatabaseLink, model.databases))),
				_1: {ctor: '[]'}
			}
		});
};
		...
		switch (_p8.ctor) {
				...
				if (_p8._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{databases: _p8._0._0, currentPage: _user$project$DjPostgres$SelectDatabasePage}),
			...
			case 'ClickDatabasePage':
				var newModel = _elm_lang$core$Native_Utils.update(
					_user$project$DjPostgres$getInitialModel,
					{
						currentDatabase: _elm_lang$core$Maybe$Just(_p8._0)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
			...
			case 'GotTables':
				if (_p8._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							_user$project$DjPostgres$getInitialModel,
							{currentDatabase: model.currentDatabase, tables: _p8._0._0, currentPage: _user$project$DjPostgres$DatabasePage}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'ClickTablePage':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						currentTable: _elm_lang$core$Maybe$Just(_p8._0._0),
						currentQueryPage: _p8._0._1
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
			...
			default:
				if (_p8._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{currentPage: _user$project$DjPostgres$TablePage, queryResult: _p8._0._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$a,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('#select-db'),
											_1: {ctor: '[]'}
										}
									},
									{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href('https://github.com/FrancoisConstant/djpostgres'),
							_1: {
								ctor: '::',
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('djPostgres'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$DjPostgres$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$DjPostgres$renderHeader(model),
			_1: {
				ctor: '::',
				_0: _user$project$DjPostgres$renderBreadcrumb(model),
				_1: {
					ctor: '::',
					_0: _user$project$DjPostgres$renderPage(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$DjPostgres$main = _elm_lang$html$Html$program(
	{init: _user$project$DjPostgres$init, view: _user$project$DjPostgres$view, update: _user$project$DjPostgres$update, subscriptions: _user$project$DjPostgres$subscriptions})();

var Elm = {};
Elm['DjPostgres'] = Elm['DjPostgres'] || {};
if (typeof _user$project$DjPostgres$main !== 'undefined') {
    _user$project$DjPostgres$main(Elm['DjPostgres'], 'DjPostgres', undefined);
}
